...
exam_admin = NestableBlueprint('exam.admin', __name__, template_folder='templates')
exam_admin_category = Blueprint('exam.admin.category', __name__, template_folder='templates')
exam_admin_question = Blueprint('exam.admin.question', __name__, template_folder='templates')
